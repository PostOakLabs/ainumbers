...
2. art-67-agentic-ai-risk-classifier
   overall_grade and governance_tier -> GATE: overall_grade='F' escalates (HALT, open OCG Section 22.8 escalation record, closed via verify_escalation_closure on the anchor worker); any passing grade continues to Stage 3 Art 12 decision-log recording.
3. art-236-build-ai-decision-log-record
