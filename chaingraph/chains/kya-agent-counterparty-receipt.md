...
- Page: https://ainumbers.co/chaingraph/chains/kya-agent-counterparty-receipt.html
- Markdown twin: https://ainumbers.co/chaingraph/chains/kya-agent-counterparty-receipt.md

## Workflow chain: Agent Counterparty Due-Diligence Receipt (KYA)
...
1. art-287-revocation-status-verifier
...
3. art-132-agent-key-rotation-auditor
