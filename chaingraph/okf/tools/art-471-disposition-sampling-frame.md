...
status: stable
sources:
  - resource: https://ainumbers.co/chaingraph/graph/nodes/art-471-disposition-sampling-frame.json
...
[executor + attester binding](../computations/art-471-disposition-sampling-frame.md) — §10.2.
