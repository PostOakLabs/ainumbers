...
status: stable
sources:
  - resource: https://ainumbers.co/chaingraph/graph/nodes/art-450-model-inventory-entry.json
...
[executor + attester binding](../computations/art-450-model-inventory-entry.md) — §10.2.
