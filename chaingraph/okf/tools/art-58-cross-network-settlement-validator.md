...
status: stable
sources:
  - resource: https://ainumbers.co/chaingraph/graph/nodes/art-58-cross-network-settlement-validator.json
...
[executor + attester binding](../computations/art-58-cross-network-settlement-validator.md) — §10.2.
