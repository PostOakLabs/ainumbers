...
resource: https://ainumbers.co/chaingraph/art-431-cfpb-1071-coverage-check.html
...
Typed `inputSchema` — see [tool page](https://ainumbers.co/chaingraph/art-431-cfpb-1071-coverage-check.html).
