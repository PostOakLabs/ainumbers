...
status: stable
sources:
  - resource: https://ainumbers.co/chaingraph/graph/nodes/art-466-dora-roi-builder.json
...
[executor + attester binding](../computations/art-466-dora-roi-builder.md) — §10.2.
