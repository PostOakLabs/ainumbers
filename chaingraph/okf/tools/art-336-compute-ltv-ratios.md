...
status: stable
sources:
  - resource: https://ainumbers.co/chaingraph/graph/nodes/art-336-compute-ltv-ratios.json
...
[executor + attester binding](../computations/art-336-compute-ltv-ratios.md) — §10.2.
