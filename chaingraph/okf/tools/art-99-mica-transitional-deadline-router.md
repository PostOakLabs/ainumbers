...
status: stable
sources:
  - resource: https://ainumbers.co/chaingraph/graph/nodes/art-99-mica-transitional-deadline-router.json
...
[executor + attester binding](../computations/art-99-mica-transitional-deadline-router.md) — §10.2.
