...
status: stable
sources:
  - resource: https://ainumbers.co/chaingraph/graph/nodes/art-271-defi-lending-health.json
...
[executor + attester binding](../computations/art-271-defi-lending-health.md) — §10.2.
