...
status: stable
sources:
  - resource: https://ainumbers.co/chaingraph/graph/nodes/art-474-validate-mt700-lc-fields.json
...
[executor + attester binding](../computations/art-474-validate-mt700-lc-fields.md) — §10.2.
