...
status: stable
sources:
  - resource: https://ainumbers.co/chaingraph/graph/nodes/art-77-t1-settlement-readiness-diagnostic.json
...
[executor + attester binding](../computations/art-77-t1-settlement-readiness-diagnostic.md) — §10.2.
