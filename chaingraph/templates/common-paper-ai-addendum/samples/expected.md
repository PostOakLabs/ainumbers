...
This AI Addendum consists of: (1) this Cover Page and (2) the Common Paper AI Addendum Standard Terms Version 1.0 identical to those posted at https://commonpaper.com/standards/ai-addendum/1.0. This AI Addendum supplements and is incorporated into the parties' underlying Agreement.
...
Improvement Restrictions: None.

### Data Retention
90 days from Input submission, then deleted.

### Output Ownership
Per Section 2.1 of the Standard Terms, Customer owns all Output.

### AI Sub-processors
None. Provider does not use third-party AI sub-processors.
