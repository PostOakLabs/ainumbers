/**
 * art-692-consolidation-cta-minority-interest.kernel.mjs
 *
...
const TOOL_ID = 'art-692-consolidation-cta-minority-interest';
const TOOL_VERSION = '1.0.0';

export const meta = {
  tool_id: TOOL_ID,
  tool_version: TOOL_VERSION,
  mcp_name: 'compute_consolidation_cta_split',
