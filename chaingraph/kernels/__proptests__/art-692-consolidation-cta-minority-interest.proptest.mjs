// art-692-consolidation-cta-minority-interest — class-K property-test FLOOR. Authored by CONSOLIDATION-CTA-BUILD-1
// per FV-PBT-FLOOR-BUILD-SPEC.md. Reserved-number rebuild: art-692 reserved to this row in
// chaingraph/graph/RESERVATIONS.json (2026-09-06) before the first kernel byte.
// kernel_digest_at_authoring: sha256:c1b2c5e457a772a715240819ffaeae1e14700f0af2a96147d0e31f29dbf0a6ed
...
//
// Run: node chaingraph/kernels/__proptests__/art-692-consolidation-cta-minority-interest.proptest.mjs

import { compute } from '../art-692-consolidation-cta-minority-interest.kernel.mjs';
import { runFixtureOracle, summarize, mulberry32, deepEqual, findShapeViolations } from './_pbt-common.mjs';

const KERNEL_ID = 'art-692-consolidation-cta-minority-interest';
