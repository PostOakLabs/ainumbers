...
const EXTERNAL_GATES = new Set((process.env.GATE_EXTERNAL ||
  'hash-sweep.mjs,verify-mcp-registered.mjs,smoke-mcp.mjs,smoke-compute.mjs,check-tool-names.mjs,check-kernel-coverage.mjs,validate-chains.mjs,linear-hash-freeze.mjs,gate-static.test.mjs,gate-semantics.test.mjs,gate-branch-coverage.test.mjs,gate-parity.test.mjs,compile-mandate-determinism.test.mjs,mandate-binding.test.mjs,validate-input-attestations.test.mjs,validate-private-inputs.test.mjs'
...
for (const row of rows) {
  ...
  // match any .mjs/.js token in the cell, even with trailing args inside backticks (e.g. `check-kernel-coverage.mjs --strict`)
