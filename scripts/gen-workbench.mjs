...
<div class="wb-grid">
  ...
  <div class="pane-right">
    ...
    <div id="artifactSection" style="display:none">
      ...
      <div class="rp-section" id="snapSection" style="display:none">
        <div class="rp-label">&#x27A1; Snap-Compatible Downstream</div>
        <div id="snapList"></div>
      </div>
    </div>
  </div>
...
async function apVerifySig(){
  ...
  return html.replace(CATALOG_PLACEHOLDER, () => catalogJson);
}
