...
export const propertyIdMap = {
  ...
  // (graded PASS, board/reference/SHADOW-PROPOSALS.md CS-145); via authored from the page's
  // own control reads:
  //   chaingraph/art-160-vida-drr-transaction-reporter.html:195 — transaction -> #transaction_value (#transaction_value read as a plain .value string)
  'art-160-vida-drr-transaction-reporter': {
    transaction: { element_id: 'transaction_value', via: 'string' },
  },
