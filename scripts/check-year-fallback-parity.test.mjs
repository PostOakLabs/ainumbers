...
if (a218Hits.length === 1) check("art-218 finding points at the fallback line (132; shifted by the TSW-3 rebase keeping main's converged-constants comment above the table)", a218Hits[0].line === 132, "line=" + a218Hits[0].line);
