// LEGALOPS-PROVE-1 — splice the art-588 / art-589 groth16 receipts into their node shards.
// Run from the worktree root:
//   node scripts/splice-legalops-proofs.mjs <staged-dir> [--apply]
//
...
if (!STAGED) { console.error('usage: splice-legalops-proofs.mjs <staged-dir> [--apply]'); process.exit(2); }
...
const TARGETS = [
  { id: 'art-588-docket-deadline-sweep', pin: 'sha256:54ec1d5b6fe7faac635820bc4b60de9ea75ea643abec9d1f312b6f54de3125fa' },
  { id: 'art-589-redline-round-classifier', pin: 'sha256:5af85fdf37a3ae3ab73a616adad96621f2fc811520c30cafb6404da7d71393c6' },
];
...
for (const t of TARGETS) {
  ...
  // deferred_reason RETAINED in place — matches the shipped art-533/538/547/566 convention.
