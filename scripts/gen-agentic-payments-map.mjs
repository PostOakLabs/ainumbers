  ...
  <div class="section">
    <div class="container">
      ...
      <div class="scope-callout">
        <p>What this page is not: it does not integrate with AgentCore, Bedrock, x402 facilitators, ACP, AP2, ERC-8004 registries, or MPP. It maps field names to the nodes that already exist on this estate, and it asserts nothing about a mapped node beyond what that node's own description computes. Where the retrieval pass found an open divergence between a node and its pinned spec (art-594, art-36), that divergence is stated in the table above; it ships no kernel edits.</p>
      </div>
    </div>
  </div>
</main>
